...
public class BookService {
	...
	public void save(Book book) throws IOException {
		...
		conn.setFixedLengthStreamingMode(json.getBytes().length); // Set the length in Bytes
		...
		conn.getResponseCode(); // Pauses execution until the server returns a value. Really needs timeout functionality.

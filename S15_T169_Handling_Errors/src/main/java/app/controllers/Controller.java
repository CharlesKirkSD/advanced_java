...
public class Controller {
	...
	public Controller() {
		...
		createPanel.setFormListener((author, title) -> {
			try {
				...
				JOptionPane.showMessageDialog(mainFrame, "Error saving book", "BookService not available",
	...
	protected void refresh() {
		...
		try {
			...
			JOptionPane.showMessageDialog(mainFrame, "Error refreshing book list", "BookService not available",
					JOptionPane.ERROR_MESSAGE);
		}
	}
}
